...
import SessionBean.RolesFacade;
...
public class RolesController implements Serializable {
    ...
    @EJB
    private SessionBean.RolesFacade ejbFacade;
    ...
    public void roll () throws IOException{
        String rol = current.getRol() ;
        String password = current.getPassword();
        
        System.out.println(rol+password);
    if(ejbFacade.verificaradmin(rol, password))    {
     ...
     FacesContext.getCurrentInstance().getExternalContext().redirect("opciones.xhtml"); 
    }

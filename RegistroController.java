...
import SessionBean.RegistroFacade;
...
public class RegistroController implements Serializable {
    ...
    @EJB
    private SessionBean.RegistroFacade ejbFacade;
    ...
    if(ejbFacade.verificarlogin(nombre, password))    {
     ...
     FacesContext.getCurrentInstance().getExternalContext().redirect("registrarse.xhtml"); 
    }
